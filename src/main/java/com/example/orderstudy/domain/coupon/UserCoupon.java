...
public class UserCoupon {
    ...
    private UserCoupon(User user, CouponPolicy couponPolicy, LocalDateTime issuedAt) {
        this.user = user;
    ...
    public static UserCoupon issue(User user, CouponPolicy couponPolicy, LocalDateTime issuedAt) {
        return new UserCoupon(user, couponPolicy, issuedAt);
    }
