...
public class CouponDtos {
    ...
    public record CouponPolicyResponse(
        ...
        static CouponPolicyResponse from(CouponPolicy policy) {
    ...
    public record IssueCouponResponse(
        ...
        static IssueCouponResponse from(UserCoupon userCoupon) {
    ...
    public record UserCouponResponse(
        ...
        static UserCouponResponse from(UserCoupon userCoupon) {
